...
function App() {
  window.onload = function() {
    ...
    document.getElementById("intro-container").style.top = document.getElementById("canvas").style.height.replace("px","")/1.55 + "px";
  ...
  const [mode,setMode] = useState(2); //dark mode
